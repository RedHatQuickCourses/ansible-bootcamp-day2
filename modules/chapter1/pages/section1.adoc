= Introduction: The Role of Private Automation Hub
...
+
image::api-token-overview.png[API Token Overview]
+
. On the API Token page, click the **Generate token** button. Your API token will be displayed.
+
image::api-token-generate.png[Generate an API Token]
+
. Click the Copy to clipboard icon to copy it.

image::api-token-copy.png[Copy the API Token]
...
+
image::navigate-namespaces.png[Namespaces navigation]
+
. Click on the **Create Namespace** button.
+
image::namespaces-overview.png[Namespaces overview]
+
...
image::create-namespace.png[Namespace creation form]
...
+
image::collection-approvals-overview.png[Collection Approvals overview]
+
...
+
image::remote-registries-overview.png[Navigate to Remote Registries]
+
. Click the **Create remote registry** button
+
image::create-remote-registry.png[Create Remote Registry]
+
...
+
image::create-remote-registry-details.png[Create Remote Registry Details]
+
...
+
image::execution-environments-navigate.png[Navigate to Execution Environments]
+
. Click the **Create execution environment** button.
+
image::create-execution-environment.png[Create Execution Environment]
+
...
image::create-execution-environment-form.png[Create Execution Environments Form]
...
+
image::execution-environment-sync.png[Sync Execution Environment]
+
...
image::execution-environment-confirm-sync.png[Confirm Sync Execution Environment]
...
+ 
image::gitea-homepage.png[Gitea Homepages]
+
...
image::devspaces-git-auth.png[Gitea Repository Containing Collection Content]
...
image::gitea-repository.png[Dev Spaces Git Authentication]
