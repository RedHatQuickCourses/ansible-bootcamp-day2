...
Create a new `execution-environment.yml` file within the `config_as_code` directory with the following content and change the 'openshift_cluster_ingress_domain' and '{aap_controller_web_url}' with the actual values before saving the file:
