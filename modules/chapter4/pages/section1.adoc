...
+
image::portal-search.png[Ansible Automation Platform in Azure Marketplace]
+
. Select your desired _Subscription_ and _Plan_ and then click **Create**.

image::aap-azure.png[Ansible Automation Platform in Azure Marketplace]
...
+
image::aap-create-basics.png[Ansible Automation Platform on Azure - Basics]
+
. Click **Next**
...
image::aap-create-networking.png[Ansible Automation Platform on Azure - Networking]
+
. Click **Next**.
...
+
image::aap-create-business-continuity.png[Ansible Automation Platform on Azure - Business Continuity]
+
. Click **Next**.
...
image::aap-requirements.png[Ansible Automation Platform on Azure - Requirements]
