...
*Note:* Due to Azure subscription restrictions, please use your own Azure account information to perform the Ansible Automation Platform deployment in the Azure lab, following the instructions provided ahead. 