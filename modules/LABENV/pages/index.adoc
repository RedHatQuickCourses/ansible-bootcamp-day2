...
. **Search** for the catalog entry: **Advanced Automation Bootcamp**.
+ 
image::1.png[]
...
=== Important Notes:
- This lab may take approximately **180 minutes** to become ready.
...
[[RHDP-Portal-Links]]
=== RHDP Portal Links
- RedHat associates: https://catalog.demo.redhat.com/catalog?search=Ansible+boot+camp&item=babylon-catalog-prod%2Fopenshift-cnv.advanced-automation-bootcamp.prod[https://Demo.redhat.com/,window=_blank]
